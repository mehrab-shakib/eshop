const styles = {
    ...
    button: 'w-[150px] bg-[#3A003D] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#FF5A19] flex items-center justify-center cursor-pointer",
